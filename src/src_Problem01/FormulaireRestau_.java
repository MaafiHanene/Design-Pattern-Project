...
public class FormulaireRestau_  extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	FormulaireRestau_ frame = new FormulaireRestau_(new JButton("="));
    ...
    public FormulaireRestau_(JButton butt) {
    ...
    public void actionPerformed(ActionEvent arg0) {
        Restaurant_ resto = new Restaurant_();
        /*if (resto.getSuperficie() + Zoo.getWinLa79a() <= Zoo.getSuperficie() && resto.count + 1 < 6) {
            ...
            if (resto.count + 1 == 6)
                JOptionPane.showMessageDialog(null, "On ne peut pas ins�rer plus de 5 Restaurants");
            else
