...
public class SupprimerEnclos_ extends JFrame implements ActionListener {
	 private JPanel contentPane;
	    private JComboBox comboBox;
	    GestionZoo_ z;


	    public SupprimerEnclos_(GestionZoo_ zoo) {
	        this.z = z;
	        setVisible(true);
	        ...
	        Iterator<Enclos_> it = zoo.getEnclosIterator();
	        while (it.hasNext()) {
	    ...
	    public void actionPerformed(ActionEvent arg0) {
	        ...
	        FormulaireZoo_.enclos.remove(comboBox.getSelectedItem());
