...
public class FormulaireEnclos_ extends JFrame {
	...
	public FormulaireEnclos_(Zoo_ zoo) {
		this.zoo = zoo;
		setVisible(true);
		...
		class Ajout implements ActionListener{
    		public void actionPerformed(ActionEvent e) {
    			...
    			try{
        			...
        			GestionZoo_.gestionEnclos.ajouterEnclos(enclos);
        			FormulaireZoo_.enclos.add(enclos);
