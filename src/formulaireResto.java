...
public class formulaireResto extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    formulaireResto frame = new formulaireResto(new JButton("="));
    ...
    public formulaireResto(JButton butt) {
