...
public class InterfaceGestion extends JFrame {
    ...
    public InterfaceGestion(Zoo zoo) {
        ...
        gauche.add(new JLabel(String.valueOf(zoo.getEnclos().size()))); ///enclos.size
        gauche.add(new JLabel("Nombre de restaurants "));
        gauche.add(new JLabel(String.valueOf(zoo.getRestos().size()))); ///restos.size
        gauche.add(new JLabel("Nombre d'animaux"));
        gauche.add(new JLabel(String.valueOf(zoo.getAnimaux().size()))); /// animaux.size
        ...
        supprEnclos.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                Supprimer_enclos sE = new Supprimer_enclos(zoo);
            }
        });
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                plan.placerEnclos(formulaireZoo.enclos);
            }
        });
